...
Examples:
  linear-tui                    # Run the interactive TUI
  linear-tui list               # List all issues
  linear-tui list -s "Backlog"  # List all backlog issues
  linear-tui me                 # List your assigned issues
  linear-tui me -s "In Progress" # List your in-progress issues
`)
}
